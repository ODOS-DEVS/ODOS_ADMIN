...
const usersListApi = createPaginatedAdminApi<BackendAdminUser, AdminUser>({
  path: "/admin/users",
  mapItem: mapAdminUser,
});

export const getUsersPage = usersListApi.getPage;
export const getUsers = usersListApi.getAll;
