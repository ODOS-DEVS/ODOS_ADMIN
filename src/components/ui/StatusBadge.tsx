...
const toneMap: Record<string, string> = {
  ...
  exchanged: "border-emerald-400/30 bg-emerald-500/10 text-emerald-200",
  pending: "border-amber-400/30 bg-amber-500/10 text-amber-100",
  pending_payment: "border-amber-400/30 bg-amber-500/10 text-amber-100",
  requested: "border-amber-400/30 bg-amber-500/10 text-amber-100",
  ...
  visible: "border-emerald-400/30 bg-emerald-500/10 text-emerald-200",
  ...
  partially_refunded: "border-orange-400/30 bg-orange-500/10 text-orange-100",
  credit: "border-emerald-400/30 bg-emerald-500/10 text-emerald-200",
  debit: "border-red-400/30 bg-red-500/10 text-red-100",
  disabled: "border-slate-400/20 bg-slate-500/10 text-slate-200",
  inactive: "border-slate-400/20 bg-slate-500/10 text-slate-200",
  limit_reached: "border-amber-400/30 bg-amber-500/10 text-amber-100",
